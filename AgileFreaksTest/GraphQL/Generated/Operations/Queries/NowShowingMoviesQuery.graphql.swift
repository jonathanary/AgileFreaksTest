...
extension AniListAPI {
  nonisolated struct NowShowingMoviesQuery: GraphQLQuery {
    static let operationName: String = "NowShowingMovies"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query NowShowingMovies($page: Int, $perPage: Int) { Page(page: $page, perPage: $perPage) { __typename pageInfo { __typename currentPage hasNextPage perPage } media(type: ANIME, format: MOVIE, sort: TRENDING_DESC, isAdult: false) { __typename ...MediaListFields } } }"#,
    ...
    nonisolated struct Data: AniListAPI.SelectionSet {
      ...
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        NowShowingMoviesQuery.Data.self
      ] }
      ...
      nonisolated struct Page: AniListAPI.SelectionSet {
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          NowShowingMoviesQuery.Data.Page.self
        ] }
        ...
        nonisolated struct PageInfo: AniListAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            NowShowingMoviesQuery.Data.Page.PageInfo.self
          ] }
        ...
        nonisolated struct Medium: AniListAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            NowShowingMoviesQuery.Data.Page.Medium.self,
